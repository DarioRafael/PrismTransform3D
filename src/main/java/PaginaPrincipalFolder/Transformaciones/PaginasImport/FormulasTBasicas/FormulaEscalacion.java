...
public class FormulaEscalacion extends JFrame {
    ...
    public FormulaEscalacion() {
        ...
        JLabel matrizGeneral = new JLabel("<html><div style='text-align: center; font-family: Courier New; font-size: 14px;'>"
                ...
                + "</table>"
                + "<div style='margin-top: 10px; font-size: 12px; color: red;'>[X' Y' Z' 1] = [X·Sx Y·Sy Z·Sz 1]</div></div></html>");
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            FormulaEscalacion frame = new FormulaEscalacion();
